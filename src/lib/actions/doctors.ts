...
import { Gender } from "@/prisma/client/enums";
...
export async function createDoctor(inputs : CreateDoctorInputs){
    try{
...
interface UpdateDoctorInput extends Partial<CreateDoctorInputs> {
  id: number;
}

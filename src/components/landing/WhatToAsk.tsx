...
const WhatToAsk = () => {
  return (
    <section className="relative py-15 px-6 overflow-hidden border-t bg-linear-to-b from-background to-muted/20">
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="bg-linear-to-br mt-22 from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500">
